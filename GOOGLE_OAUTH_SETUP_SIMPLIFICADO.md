...
- **Supabase Auth Providers**: https://supabase.com/dashboard/project/dcigykpfdehqbtbaxzak/auth/providers
...
```
https://dcigykpfdehqbtbaxzak.supabase.co/auth/v1/callback
...
- **URIs de redirect**: Cole as 3 URLs listadas acima
...
1. Acesse: https://supabase.com/dashboard/project/dcigykpfdehqbtbaxzak/auth/providers
2. Clique em **"Google"**
