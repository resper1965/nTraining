...
- [`testLogin`](scripts/test-login.ts#L14) (function)
- [`createSupabaseQueryMock`](tests/mocks/supabase.ts#L17) (function)
- [`createSupabaseClientMock`](tests/mocks/supabase.ts#L55) (function)
- [`createQueryBuilderMock`](tests/unit/services/course.service.test.ts#L47) (function)
