...
## Repository map
- `ACCESSIBILITY.md/` — explain what lives here and when agents should edit it.
- `ADD_SERVICE_ROLE_KEY.md/` — explain what lives here and when agents should edit it.
- `AGENTES_DISPONIVEIS.md/` — explain what lives here and when agents should edit it.
- `APLICAR_SCHEMA_NOVO_PROJETO.md/` — explain what lives here and when agents should edit it.
- `app/` — explain what lives here and when agents should edit it.
- `AUDITORIA_AUTENTICACAO_COMPLETA.md/` — explain what lives here and when agents should edit it.
- `AUDITORIA_FINAL.md/` — explain what lives here and when agents should edit it.
- `AUDITORIA_SUPABASE.md/` — explain what lives here and when agents should edit it.
